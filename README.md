...
[![Open in Dev Containers](https://img.shields.io/static/v1?style=for-the-badge&label=Dev%20Containers&message=Open&color=blue&logo=visualstudiocode)](https://vscode.dev/redirect?url=vscode://ms-vscode-remote.remote-containers/cloneInVolume?url=https://github.com/mavencloudservice/azure-search-openai-demo)

## Table of Contents

- [ChatGPT-like app with your data using Azure OpenAI and Azure AI Search (Python)](#chatgpt-like-app-with-your-data-using-azure-openai-and-azure-ai-search-python)
